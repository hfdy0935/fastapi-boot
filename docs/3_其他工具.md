...
from fastapi import FastAPI
import uvicorn
from modules.tortoise_utils1.app import app as app1
from modules.tortoise_utils2.app import app as app2
...
:two: `modules.tortoise_utils1.app.py`
```py
from fastapi_boot.core import provide_app
from modules.tortoise_utils1.controller import UserController
...
:three: `modules.tortoise_utils1.controller.py`
```py
...
:four: `modules.tortoise_utils2.app.py`
```py
from fastapi_boot.core import provide_app
from modules.tortoise_utils2.controller import UserController


app = provide_app(controllers=[UserController])
```

:five: `modules.tortoise_utils2.controller.py`
```py
from fastapi_boot.core import Controller, Get
